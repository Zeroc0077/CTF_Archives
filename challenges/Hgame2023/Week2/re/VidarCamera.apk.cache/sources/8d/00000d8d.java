...
public final class UIntArray implements Collection<UInt>, KMappedMarker {
    ...
    public static int[] m176constructorimpl(int[] storage) {
    ...
    public static boolean m179equalsimpl(int[] iArr, Object obj) {
        return (obj instanceof UIntArray) && Intrinsics.areEqual(iArr, ((UIntArray) obj).m190unboximpl());
    }
    ...
    public boolean equals(Object obj) {
        return m179equalsimpl(this.storage, obj);
    }
    ...
    public final /* bridge */ boolean contains(Object obj) {
        if (obj instanceof UInt) {
            return m189containsWZ4Q5Ns(((UInt) obj).m173unboximpl());
        }
        return false;
    }
    ...
    public static boolean m178containsAllimpl(int[] iArr, Collection<UInt> elements) {
        boolean z;
        Intrinsics.checkNotNullParameter(elements, "elements");
        Collection<UInt> collection = elements;
        if (!collection.isEmpty()) {
            for (Object obj : collection) {
                if ((obj instanceof UInt) && ArraysKt.contains(iArr, ((UInt) obj).m173unboximpl())) {
                    z = true;
                    continue;
                } else {
                    z = false;
